...
`AutoDataImporter.github-safe.ipynb` is a notebook that scans a folder for spatial files like `.kml`, `.kmz`, and `.shp`, then adds them into the current ArcGIS Pro map.
