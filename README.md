...
[Dominant_Dlass_per_Polygon.py](https://github.com/yangchh17/GIS-automation-scripts/blob/main/dominant_class_per_polygon.py) Summarises a single-band integer (categorical) raster over a set of polygons.
